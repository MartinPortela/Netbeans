...
public class ClaseMath 
{
    public static void main(String[] args) 
    {
        ...
        // algunos mútodos de la clase Math
        ...
        System.out.println("\nNúmero aleatorio entre 1 y 100  = " + (int)(Math.random()*100+1));
        System.out.println("\ndel valor [-2.5] primero valor absoluto y luego redondea");
        System.out.println( Math.round(Math.abs(d)));
        
        // este bucle imprime 10 números aleatorios en el rango [1..100]
        System.out.println("\n10 números aleatorios en el rango [1..100]");
        for (i = 1 ; i <= 10 ; i++ )
        {
            numero = (int)(Math.random()*100+1);
            System.out.print(numero+"  ");
        }
        // este bucle imprime 10 números aleatorios en el rango [5..9]
        System.out.println("\n\n10 números aleatorios en el rango [5..9]");
        int desde = 5, hasta = 9;
        for (i = 1 ; i <= 10 ; i++ )
        {
